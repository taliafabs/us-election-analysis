#### Preamble ####
# Purpose: Simulates the survey data where state, sex, age, race, education,
# and area type predict support for Biden
...
simulated_poststrat_data <- tibble(
  # preferred 2024 presidential candidate
  presvote24 = sample(presidential_candidates, size=sim_size, replace=TRUE),
  # state
